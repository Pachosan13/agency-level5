...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-12 mx-auto h-[30rem] md:h-[40rem] w-full border-4 border-accent-violet/30 p-2 md:p-6 bg-bg-card rounded-[30px] shadow-[0_0_80px_rgba(124,58,237,0.15)]"
    >
